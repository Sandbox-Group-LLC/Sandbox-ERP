...
export default function ExpensesPage() {
  ...
  async function handleAddExpense(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      await createExpenseEntry(projectId, {
  ...
  async function handleEditExpense(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault()
  ...
  async function handleImport() {
    ...
    try {
      const result = await importExpenseEntriesFromCSV(projectId, csvData)
    ...
    <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="p-4 rounded-md bg-muted">
                        ...
                        <p className="text-sm text-green-600">
                          ✓ {importResult.successCount} expenses imported successfully
                        </p>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent className="max-h-[90vh] overflow-hidden flex flex-col">
          ...
          {editingEntry && (
            <ScrollArea className="flex-1 pr-4">
              <form id="edit-expense-form" onSubmit={handleEditExpense} className="space-y-4">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    name="budgetLineId"
                    defaultValue={editingEntry.budgetLineId || ""}
                  >
                    <SelectTrigger className="text-base">
                      <SelectValue placeholder="Select budget line (optional)" />
                    </SelectTrigger>
          ...
          <DialogFooter className="pt-4">
            ...
            <Button type="submit" form="edit-expense-form" disabled={submitting}>
